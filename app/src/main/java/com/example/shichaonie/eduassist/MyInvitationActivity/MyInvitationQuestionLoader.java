...
public class MyInvitationQuestionLoader extends android.support.v4.content.AsyncTaskLoader<ArrayList<QuestionData>> {

    private String mUserId;

    public MyInvitationQuestionLoader(Context context, String userId) {
        super(context);
        mUserId = userId;
    }
    ...
    public ArrayList<QuestionData> loadInBackground() {
        String is;
        String newUrl = URL_QUESTIONS_BASE + "invitation/" + mUserId + "/";
